...
function program8(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</div>\n<div class='ui_container' id='resources_container'>\n    <ul id='resources'>\n    </ul>\n\n    <div class=\"footer\">\n        <br>\n        <br>\n        <h4 style=\"color: #999\">[ <span style=\"font-variant: small-caps\">base url</span>: ";
...
(function() {
  var ContentTypeView, MainView, OperationView, ParameterContentTypeView, ParameterView, ResourceView, ResponseContentTypeView, SignatureView, StatusCodeView, SwaggerUi, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.render = function() {
      var counter, id, resource, resources, _i, _len, _ref2;

      $(this.el).html(Handlebars.templates.main(this.model));
      resources = {};
      counter = 0;
      _ref2 = this.model.apisArray;
  ...
  ResourceView = (function(_super) {
    ...
    function ResourceView() {
      _ref2 = ResourceView.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
    ...
    ResourceView.prototype.render = function() {
      var counter, id, methods, operation, _i, _len, _ref3;

      $(this.el).html(Handlebars.templates.resource(this.model));
      methods = {};
      _ref3 = this.model.operationsArray;
  ...
  OperationView = (function(_super) {
    ...
    function OperationView() {
      _ref3 = OperationView.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
    ...
    OperationView.prototype.render = function() {
      var contentTypeModel, isMethodSubmissionSupported, k, o, param, responseContentTypeView, responseSignatureView, signatureModel, statusCode, type, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref4, _ref5, _ref6, _ref7;
      ...
      if (this.model.authorizations) {
        _ref4 = this.model.authorizations;
        for (k in _ref4) {
          v = _ref4[k];
          if (k === "oauth2") {
    ...
    OperationView.prototype.handleFileUpload = function(map, form) {
      var bodyParam, el, headerParams, o, obj, param, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref4, _ref5, _ref6, _ref7,
        _this = this;

      log("it's a file upload");
      _ref4 = form.serializeArray();
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        o = _ref4[_i];
        if ((o.value != null) && jQuery.trim(o.value).length > 0) {
          map[o.name] = o.value;
      ...
      log(headerParams);
      _ref7 = form.find('input[type~="file"]');
      for (_l = 0, _len3 = _ref7.length; _l < _len3; _l++) {
        el = _ref7[_l];
    ...
    OperationView.prototype.getSelectedValue = function(select) {
      var opt, options, _i, _len, _ref4;

      if (!select.multiple) {
        return select.value;
      } else {
        options = [];
        _ref4 = select.options;
        for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
          opt = _ref4[_i];
          if (opt.selected) {
    ...
    OperationView.prototype.formatXml = function(xml) {
      ...
      _fn = function(ln) {
        ...
        padding = ((function() {
          ...
          _results = [];
          for (j = _j = 0, _ref4 = indent; 0 <= _ref4 ? _j < _ref4 : _j > _ref4; j = 0 <= _ref4 ? ++_j : --_j) {
            _results.push('  ');
          }
          return _results;
        })()).join('');
  ...
  StatusCodeView = (function(_super) {
    ...
    function StatusCodeView() {
      _ref4 = StatusCodeView.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  SignatureView = (function(_super) {
    ...
    function SignatureView() {
      _ref6 = SignatureView.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  ContentTypeView = (function(_super) {
    ...
    function ContentTypeView() {
      _ref7 = ContentTypeView.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  ParameterContentTypeView = (function(_super) {
    ...
    function ParameterContentTypeView() {
      _ref9 = ParameterContentTypeView.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
